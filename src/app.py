...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork, strategy, and match play on the field",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Develop ball handling, shooting, and defensive skills",
    ...
    "Drama Club": {
        "description": "Learn acting techniques and perform scenes with classmates",
